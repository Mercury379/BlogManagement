...
public class CodeGenerator {
    ...
    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "newland-blog-article";
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("新大陆-www.newland.com");
        ...
        pc.setParent("com.newland.blog"); //父包名
        pc.setController(MODULE_NAME+".controller"); // com.newland.blog.aritcle.controller
        ...
        pc.setEntity("entities");//实体类存储包名 com.newland.blog.entities
